            ...
            <div className="space-y-6">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  >
                    chanukarathnayake1012@gmail.com
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-white">Minhettiya, Kurunegala, Sri Lanka</p>
                </div>
              </div>
            </div>
              ...
              <div className="flex space-x-4">
                {socialLinks.map((social, index) => (
                  <a
                    ...
                    className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center text-gray-400 hover:bg-blue-400 hover:text-white transition-all duration-300"
            ...
            <form onSubmit={handleSubmit} ref={form}>
              <div className="mb-6">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-gray-800/50 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-300 text-white placeholder-gray-400"
                />
              </div>
              ...
              <div className="mb-6">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 bg-gray-800/50 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-300 text-white resize-none placeholder-gray-400"
                />
              </div>
